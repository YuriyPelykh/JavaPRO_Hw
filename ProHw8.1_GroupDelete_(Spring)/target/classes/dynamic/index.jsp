                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <button class="btn btn-default navbar-btn" type="button" id="delete_group" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Delete Group</button>
                                <ul class="dropdown-menu">
                                    <c:forEach items="${groups}" var="group">
                                        <li><a class="dropdown-item" href="/group/delete/${group.id}">${group.name}</a></li>
                                    </c:forEach>
                                </ul>
                            </li>
                            <li class="dropdown">
